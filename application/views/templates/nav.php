                            ...
                            <div class="header-button text-right">
                                <div class="account-wrap ">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="content">
                                            <a class="js-acc-btn" href="<?php base_url()?>dashboard"><?php echo $this->session->userdata('user')?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="content">
                                                    ...
                                                    <span class="email"><?php echo $this->session->userdata('nombre')  ?></span>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer">
                                                <a href="<?php base_url()?>Login_Controller/logout">
