...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2018 a las 18:56:05
...
(1, 'factura-s9q4armxYn-92695-9240', 6, 2, '1.2'),
(2, 'factura-s9q4armxYn-92695-9240', 7, 2, '5'),
(3, 'factura-s9q4armxYn-92695-9240', 8, 6, '5.94'),
(4, 'factura-s9q4armxYn-92695-9240', 13, 6, '0.6');
...
('factura-s9q4armxYn-92695-9240', '2018-10-30', 'cliente-q53hmSO4pu-2552385-1706', 1);
...
(6, 'Manzana verde', '0.60', 0, 2),
(7, 'Sandia', '2.50', 5, 2),
(8, 'Coca cola lata 12 onzas', '0.99', 8, 3),
(9, 'Hi Energy', '0.50', 0, 3),
(10, 'Carro 4x4 Toy', '4.55', 8, 4),
(11, 'Set de cocina ', '5.99', 19, 4),
(12, 'Celular juguete con sonido Pepa pig', '3.55', 28, 4),
(13, 'Agua de bolsa', '0.1', 51, 3);
...
--
ALTER TABLE `detalle`
  MODIFY `num_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
